...
int main(void)
{
	...
	//Inputs
	// Low to high compare
	int testInput1[9] = { 2,10,654,213,43534,34,666,11,1 };
	int testInput2[9] = { 97,65,78,96,445,31156,2226,33126,2563 };

	// High to low compare
	int testInput3[9] = { 32,65,546,8798,541,564,310,021651,56465 };
	int testInput4[7] = { -10,-232,65,-654,698,-1,678 };

	// Absolute low to high compare
	int testInput5[11] = { 54,654,-98,-741,-546,542,96,331,154,687,983 };
	int testInput6[4] = { 159,258,357,654 };

	// Absolute high to low compare
	int testInput7[4] = { 456,753,852,951 };
	int testInput8[7] = { 0,0,NULL,1 };

	// Expected outputs
	// Low to high result
	int expectedOutput1[6] = { 2, 10, 34, 213, 654, 43534 };
	int expectedOutput2[12] = { 1,11,65,78,96, 97, 445, 666, 2226, 2563, 33126 };

	// High to low result
	int expectedOutput3[9] = { 0 };
	int expectedOutput4[7] = { 0 };

	// Absolute low to high result
	int expectedOutput5[11] = { 0 };
	int expectedOutput6[7] = { 0 };

	// Absolute high to low result
	int expectedOutput7[4] = { 0 };
	int expectedOutput8[7] = { 0 };
	...
	for (int i = 1; i < 4; i++)
	{
		if (compare == 1)
		{
			bubble_sort(*(intArray_ptr),numElements,low_to_high_compare(x, y));
		}
		else if (compare == 2)
		{
			high_to_low_compare(x, y);
		}
		else if (compare == 3)
		{
			absolute_low_to_high_compare(x, y);
		}
		else if (compare == 4)
		{
			absolute_high_to_low_compare(x, y);
		}
		else
		{
...
int low_to_high_compare(int x, int y)
{
	...
	//return 0; // You'll want to modify this
}
